...
*Collinearity* is when two inputs are highly correlated (eg > 0.5).  This can be identified with a simple `cor()` command and one of these inputs should be considered for removal:
